...
from dataset.utils import get_visible_mask, get_occlusion_mask, transform, \
    encode_binary_labels
import dataset.nuscenes_utils as nusc_utils
from experiments import nuscenes_objects_base as exp_config


output_root = '/srv/beegfs02/scratch/tracezuerich/data/cany/monomaps_labels_vanilla_deneme/'
...
if __name__ == '__main__':
    ...
    logging.error('OUTPUT FOLDER IS '+ output_root)
    ...
    for scene in nuscenes.scene:
        logging.error(str(scene['token']))
  
        process_scene(nuscenes, map_data, scene, exp_config)
